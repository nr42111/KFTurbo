Class KFPInvasionLoginMenu extends SRInvasionLoginMenu;
...
function InitComponent(GUIController MyController, GUIComponent MyOwner)
{
	...
	Panels[1].ClassName = string(class'KFPTab_MidGamePerks');
...
function bool ButtonClicked(GUIComponent Sender)
{
	...
	{
		// Profile
		Controller.OpenMenu(string(Class'KFPProfilePage'));
	}
