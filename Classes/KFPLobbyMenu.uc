class KFPLobbyMenu extends SRLobbyMenu;

function bool ShowPerkMenu(GUIComponent Sender)
{
	if (PlayerOwner() != none)
		PlayerOwner().ClientOpenMenu(string(Class'KFPProfilePage'), false);
	return true;
}
...
defaultproperties
{
     Begin Object Class=KFPLobbyFooter Name=BuyFooter
     ...
     End Object
     t_Footer=KFPLobbyFooter'KFTurbo.KFPLobbyMenu.BuyFooter'
